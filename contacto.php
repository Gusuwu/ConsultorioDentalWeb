...
<main id="main" class="l-m" role="main">
	...
	<div class="section-wrapper cf">
		<div class="section-wrapper-content cf">
			<section class="s section default-01 default sc-w">
						...
						<div class="content ez cf">
							<div class="ez-c">
								<div class="column-wrapper cw cf">
									<div class="cw-c c-s-hc cf">
										<div class="column-content c pr cf pr-0 pr-320" style="width:50%;">
											<div class="c-c c-s-h cf">
												<div class="b b-text cf">
													<div class="b-c b-text-c b-s b-s-t60 b-s-b60 cf"><h1>Info de contacto</h1>

															<h2>&nbsp;</h2>

															<h3>SONRISA FELIZ</h3>

															<h3>Gabriel Carrasca 1646, Resistencia, Chaco, 3500</h3>

															<h3>draanasonrisa@gmail.com</h3>

															<h3>(+54)&nbsp;3624 904235</h3>
													</div>
												</div>
												<div class="b b-map b-s" style="margin-left:0%;margin-right:0%;">
													<div class="b-c" id="wnd_MapBlock_578974_container" style="position:relative;padding-bottom:71.05%;">
										...
										<div class="column-content c pr cf pr-0 pr-320" style="width:50%;">
											<div class="c-c c-s-h cf">
												<div class="b b-text cf">
													<div class="b-c b-text-c b-s b-s-t60 b-s-b60 cf"><h1>Consultas en línea</h1>

														<h2><br>
														Citas médicas</h2>

														<h3>Lun&nbsp;-&nbsp;Vie:&nbsp;8am - 6pm</h3>
													</div>
												</div>
												<div class="b form block cf typo-07">
													...
													<div class="formulario">
														...
														<!-- <p style="font-family: 'Noto Sans JP', sans-serif;color: white;">Nombre</p>-->
														<div>
															<div class="form-input form-text cf wnd-form-field wnd-required">
																<label for="field-wnd_ShortTextField_554595">
				...
				<!--										
				<label for="nombre" style="margin:11px 20px 0 0; color: white; text-transform: uppercase;text-shadow: 0px 1px 0px #fff;">Su nombre</label> -->
																<input type="text" name="nombre" placeholder="Nombre" required style="width: 470px;height: 35px; font-family: 'Noto Sans JP', sans-serif;">
															</div>
															<div class="form-input form-email cf wnd-form-field wnd-required">
																<label for="field-wnd_EmailField_206114">
																	<span class="inline-text">
																		<span class="link">Email&nbsp;</span>
																	</span>
																</label>
				<!--
				<label for="correo" style="margin:11px 20px 0 0; color: white; text-transform: uppercase;text-shadow: 0px 1px 0px #fff;">Direccion</label> -->
																<input type="email" name="correo" placeholder="alguien@algo.com" required style="width: 470px;height: 35px; font-family: 'Noto Sans JP', sans-serif;">
															</div>
															<div class="form-input form-textarea cf wnd-form-field wnd-required">
																<label for="field-wnd_LongTextField_835449">
																	<span class="inline-text">
																		<span class="link">Mensaje</span>
																	</span>
																</label>
				<!-- <label for="mensaje" style="margin:11px 20px 0 0; color: white; text-transform: uppercase;text-shadow: 0px 1px 0px #fff;">Su mensaje</label> -->
																<textarea name="mensaje" placeholder="Mensaje" required style="width: 470px;height: 110px;font-family: 'Noto Sans JP', sans-serif;"></textarea>
																<br>
																

															</div>
															<div class="form-submit b-btn cf b-btn-3">
																	<button class="b-btn-l" type="submit" value="wnd_FormBlock_477441">
												...
												<div class="b b-text cf">
													<div class="b-c b-text-c b-s b-s-t60 b-s-b60 cf"><p>Confirmaremos tu cita en las próximas 24 horas.</p>
													</div>
												</div>
											</div>
										</div>
								...
								<div class="b b-s b-s-t150 b-s-b150 b-btn b-btn-1 wnd-align-center">
									<div class="b-btn-c">
										<a class="b-btn-l" href="https://api.whatsapp.com/send?phone=+5493624904235" rel="nofollow" target="_blank">
											<span class="b-btn-t">Mandanos un Whatsapp</span>
										</a>
									</div>
								</div>
							</div>
