            ...
            <div class="panel-heading">
              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <span class="help-block text-muted small-font" style="padding-top:10px;">Número</span><input requeried=""type="tel" class="form-control" placeholder="Número de la tarjeta" maxlength="12">
                </div>
                <div class="col-md-12">
              ...
              <div class="row">
                ...
                <div class="col-md-3 col-sm-3 col-xs-3">
                  <span class="help-block text-muted small-font">Año</span> <input required="" type="tel" class="form-control" placeholder="AA" maxlength="2">
                </div>
                <div class="col-md-3 col-sm-3 col-xs-3">
